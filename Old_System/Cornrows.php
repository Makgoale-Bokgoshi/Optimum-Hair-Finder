	...
	<?php 
		...
		$db=mysql_select_db($dbname,$con) or die("Failed to connect to MySQL: " . mysql_error());
		    ...
		    $result = mysql_query("SELECT DISTINCT Hairstyle_Picture FROM `hair_styles`,`pricing` WHERE hair_styles.Category_ID = 2 AND hair_styles.Style_ID = pricing.Style_ID");
			///*where Category_ID=1*/
		    while($row = mysql_fetch_assoc($result)) 
		    { 
				echo '<img src="./Style_Pictures/Cornrows/'.$row["Hairstyle_Picture"]. '" alt="" width="225" height="200"  style="margin-right: 5px " onclick="showX(src,alt)"/>';
