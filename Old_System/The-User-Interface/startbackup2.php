											...
											while($i < $hnum){
												for($j = 0; $j < $lnum; $j++){
													if($hairArr[$i]['Studio_Name'] == $locArr[$j]['Studio_Name']){
														...
														$res=mysql_query("SELECT `Studio_Name`,`Address_link`,`Telephone` FROM `all_studios` WHERE Studio_Name = '$var'");
														...
														echo '		<a href="Images.php" class="view">View salon details</a>';
																echo '</div>';
																echo '</div>
																</div>
