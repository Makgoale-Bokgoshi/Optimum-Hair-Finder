...
$db=mysql_select_db($dbname,$con) or die("Failed to connect to MySQL: " . mysql_error());
    ...
    $result = mysql_query("SELECT Picture,Style_Description FROM hair_styles");
//    $name = mysql_query("SELECT Style_Description FROM hair_styles");
	
    while($row = mysql_fetch_assoc($result)) 
    { echo '<a href="booking.php">';
echo '<img src="./Style_Pictures/'.$row["Picture"]. '" width="225" height="200"  style="margin-right: 5px " onclick="showX(src,'.$row["Style_Description"].')"/></a>';
