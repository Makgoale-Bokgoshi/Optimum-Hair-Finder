...
include 'define.php';	
	$var=$_GET['id']; 
	$result = mysqli_query($con,"SELECT DISTINCT pricing.Hairstyle_Picture from hair_styles,hair_category,pricing where hair_styles.Category_ID=3 and hair_styles.Style_ID=pricing.Style_ID and pricing.Studio_ID=$var");
	
    while($row = mysqli_fetch_assoc($result)) 
    { 
echo '<a href="#" data-toggle="modal" data-target="#myModal4"><img src="./Style_Pictures/'.$row["Hairstyle_Picture"]. '" width="225" height="200"  style="margin-right: 5px "/></a>';
