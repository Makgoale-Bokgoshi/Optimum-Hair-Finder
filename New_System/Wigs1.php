...
<?php
	...
	include 'define.php';
		$var=$_GET['id']; 
	$result = mysqli_query($con,"SELECT DISTINCT pricing.Hairstyle_Picture from hair_styles,hair_category,pricing where hair_styles.Category_ID=8 and hair_styles.Style_ID=pricing.Style_ID and pricing.Studio_ID='$var'");
