...
$db=mysqli_select_db($con,$dbname) or die("Failed to connect to MySQL: " . mysqli_error());
    ...
    $result = mysqli_query($con,"SELECT distinct Hairstyle_Picture FROM pricing where Style_ID IN (SELECT Style_ID from hair_styles where Category_ID = 1)");
	///*where Category_ID=1*/
...
>>>>>>> c1ac01a71d62aa50b6322fe9587488a1c19ee2cd:The%2520UI/Hair_Cut.php
