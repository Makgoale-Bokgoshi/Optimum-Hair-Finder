...
include 'define.php';
	$var=$_GET['id'];
	$result = mysqli_query($con,"SELECT DISTINCT pricing.Hairstyle_Picture from hair_styles,hair_category,pricing where hair_styles.Category_ID=4 and hair_styles.Style_ID=pricing.Style_ID and pricing.Studio_ID='$var'");
    ...
    <div class="modal-dialog modal-lg">
      ...
      <div class="modal-content">
        <div class="modal-header">
         ...
         <h4 class="modal-title" style="text-align: center;">Chemicals and Hair wash </h4>
        </div>
