...
$db=mysqli_select_db($con,$dbname) or die("Failed to connect to MySQL: " . mysqli_error());
    ...
    while($row = mysqli_fetch_assoc($result)) 
    { 
echo '<a href="#" data-toggle="modal" data-target="#myModal4" ><img src="./Style_Pictures/Cornrows/'.$row["Hairstyle_Picture"]. '" width="225" height="200"  style="margin-right: 5px "/></a>';
        
    }
	?>
	</body>
	</html>
>>>>>>> c1ac01a71d62aa50b6322fe9587488a1c19ee2cd:The%2520UI/Cornrows.php
