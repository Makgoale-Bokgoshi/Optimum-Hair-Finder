...
<div class="agent">
<div class="ag-bt"><h3 style="text-align: -moz-center;">Wigs</h3> </div>
...
include 'define.php';
    ...
    { 
echo '<a href="#" id="link1" data-toggle="modal" data-target="#myModal4"><img src="./Style_Pictures/Wigs/'.$row["Hairstyle_Picture"]. '" width="225" height="200"  style="margin-right: 5px "/></a>';
    ...
    <div class="modal-dialog modal-lg">
      ...
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title" style="text-align: center;"> Wigs </h4>
        </div>
